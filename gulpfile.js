...
gulp.task('injectHTML', function(){
	return multipipe(
		...
		inject(gulp.src('src/html/nav.html'), {
			starttag: '<!-- inject:nav:html -->',
			transform: function (filePath, file) {
				return file.contents.toString();
			}
		}),
		inject(gulp.src('src/html/main.html'), {
			starttag: '<!-- inject:main:html -->',
			transform: function (filePath, file) {
				return file.contents.toString();
			}
		}),
		inject(gulp.src('src/html/aside.html'), {
			starttag: '<!-- inject:aside:html -->',
			transform: function (filePath, file) {
				return file.contents.toString();
			}
		}),
